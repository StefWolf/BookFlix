    ...
    return(
        <>
            <main>
                        ...
                        <div className=" w-full h-screen  bg-slate-900/50 ">
                            <div className="lg:ml-32 lg:mt-24 w-[500px]  min-h-[300px]"> 
                                <div className="p-5 flex-col">
                                    <h1 className="text-[40px] text-cyan-700"><strong>Bem vindo ao BookFlix!</strong></h1>
                                    ...
                                    <div className="items-center justify-center mt-4">
                                        <Center>
                                            <Button colorScheme="cyan" className="justify-center" variant='outline' size='lg'>
               ...
               <div className="bg-slate-300 w-full min-h-[500px]">
